...
const title = "Topisle 顶屿 — 屏幕顶端，你的本地工作岛";
const description = "常驻 macOS 刘海的本地工作台：首页、待办、笔记、链接、录制、密钥与可选剪贴板，数据留在当前 Mac。";

export const metadata: Metadata = {
  metadataBase: new URL("https://wind-far.github.io/Topisle/"),
  title,
  description,
  applicationName: "Topisle",
  keywords: ["Topisle", "macOS 刘海", "Mac 待办", "本地工作台", "Apple Silicon"],
  ...
  openGraph: {
    ...
    title,
    description,
    images: [{ url: assetPath("/og.png"), width: 1200, height: 630, alt: "Topisle 官网分享封面" }],
  },
